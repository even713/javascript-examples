 ...
 * To delete useless message , I modify the  jarvis.widget.min.js.
 * two points: first: changed the content to "" instead of  "warning: The action is undone.
 * second: modified the header.children('h2') to header.children('span'). 
 */
! function(a, b, c, d) {
    function e(b, c) {
    ...
    e.prototype = {
        ...
        _clickEvents: function() {
            ...
            d._settings(), d.widget.on(clickEvent, ".jarviswidget-toggle-btn", function(b) {
                ...
                var c = a(this).parents(d.o.widgets),
                    e = c.attr("id"),
                    f = c.children("header").children("span").text();
